...
public class TemperatureAddActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                temperature.value = Float.parseFloat(((EditText) findViewById(R.id.temperatureValue)).getText().toString());

                SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy hh:mm");
                try {
                    temperature.date = dateFormat.parse(editTime.getText().toString());
    ...
    public void onDateSet(com.wdullaer.materialdatetimepicker.date.DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        Date date = new Date();
        TimePickerDialog pickerDialog = TimePickerDialog.newInstance(TemperatureAddActivity.this, date.getHours(), date.getMinutes(), true);
